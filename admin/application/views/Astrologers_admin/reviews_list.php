                  ...
                  <table id="" class="table table-bordered table-striped ">
                     <thead>
                       ...
                       <?php if ($list): ?>
                          ...
                          <!--     
                             <?php if( $key->status){?>
                              <a class="btn btn-sm btn-warning" href="<?php echo base_url();?>reviews/reviews_status/<?php echo $key->id; ?>/0" onclick="return confirm('Are you sure you want to Deactivate.')"> 
                              ...
                              <?php
                                 ...
                                 {
                                 ?>
                              <a class="btn btn-sm btn-success" href="<?php echo base_url();?>reviews/reviews_status/<?php echo $key->id; ?>/1" onclick="return confirm('Are you sure you want to Activated')"> 
