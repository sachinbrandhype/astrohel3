<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <ol class="breadcrumb">
                <li><a data-toggle='modal' data-target='#add_category'><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add Category</b></button></a>
            </ol>
                                ...
                                <div id="update_category_<?=$card->id?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Edit Puja Category</h4>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="number" value="<?=$card->position?>"  min="0" name="position" class="form-control" onkeyup="if(parseInt(this.value)<0){ this.value =0; return false; }" placeholder="Position">
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>pooja/delete_pooja_category/<?php echo $card->id; ?>" onClick="return doconfirm()">
