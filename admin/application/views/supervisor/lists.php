<div class="content-wrapper">
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            <li><a data-toggle='modal' data-target='#add_venue'><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add Supervisor</b></button></a>
         </ol>
         <div class="col-xs-12">
            <!-- /.box -->
            <div class="box">
                  ...
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="center">
                            <?php $location = $this->db->get_where('puja_location',array("id"=>$card->location))->row();
                            echo $location->name; ?>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>supervisor/delete_supervisor/<?php echo $card->id; ?>" onClick="return doconfirm()">
