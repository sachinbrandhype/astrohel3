      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               ...
               Day Wise Timing</a>
               <!-- <a class="btn btn-sm btn-warning" href="<?=base_url('pooja/time_slots_manage_by_location_demo/'.$pooja_location_id)?>" >
                  Day Wise Timing by schedule manager</a> -->
              <!--  <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-default_any" >
               Any Time Timing</a> -->
               <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>pooja/datewisetime_list/<?php echo $pooja_location_id ; ?>">
...
<div class="modal fade bd-example-modal-lg" id="modal-default_any">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title"> Any Time Timing</h4>
         </div>
         <div class="modal-body table-responsive">
            <form role="form" action="<?=base_url('Pooja/any_time_slots_manage_by_location');?>" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">
               <div class="box-body">
                  <div class="col-md-12">
                     <?php   
                        // print_r($pooja_location->stock);
                           @$monday = json_decode($pooja_location->anytime_stock)->mon;
                           @$tuesday = json_decode($pooja_location->anytime_stock)->tue;
                           @$wednesday = json_decode($pooja_location->anytime_stock)->wed;
                           @$thursday = json_decode($pooja_location->anytime_stock)->thu;
                           @$friday = json_decode($pooja_location->anytime_stock)->fri;
                           @$saturday = json_decode($pooja_location->anytime_stock)->sat;
                           @$sunday = json_decode($pooja_location->anytime_stock)->sun;
                             // print_r($tuesday);    
                                 ?>
                     <div class="row">
                        <div class="col-md-12">
                           <!--  <label>Any Time Timing</label> -->
                                       ...
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group">
                                             <div class="input-group">
                                                <input type="number"  min="1" name="monday" class="form-control  clinic_start1" value="<?php if(isset($monday) && !empty($monday)){ echo $monday; } ?>">
                                                <input type="hidden" name="any_id" value="<?php echo $pooja_location->id ;?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group ">
                                             <div class="input-group">
                                                <input type="number"  min="1" name="tuesday" class="form-control c11" value="<?php if(isset($tuesday) && !empty($tuesday)){ echo $tuesday; } ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group">
                                             <div class="input-group">
                                                <input type="number"  min="1" name="wednesday" class="form-control  c11" value="<?php if(isset($wednesday) && !empty($wednesday)){ echo $wednesday; } ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                 <tr>
                                    ...
                                    <td>
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group">
                                             <div class="input-group">
                                                <input type="number"  min="1" name="thursday" class="form-control  c11" value="<?php if(isset($thursday) && !empty($thursday)){ echo $thursday; } ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group">
                                             <div class="input-group">
                                                <input type="number"  min="1" name="friday" class="form-control  c11" value="<?php if(isset($friday) && !empty($friday)){ echo $friday; } ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group">
                                             <div class="input-group">
                                                <input type="number"  min="1" name="saturday" class="form-control  c11" value="<?php if(isset($saturday) && !empty($saturday)){ echo $saturday; } ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="bootstrap-timepicker">
                                          <div class="form-group">
                                             <div class="input-group">
                                                <input type="number" min="1"  name="sunday" class="form-control  c11" value="<?php if(isset($sunday) && !empty($sunday)){ echo $sunday; } ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </td>
...
<div class="modal fade bd-example-modal-lg" id="modal-default">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Day Wise Timing</h4>
         </div>
         <div class="modal-body table-responsive">
            <form class="form-horizontal" name="doctor_break_time"  id="doctor_break_time"  method="post" action="">
               <div class="box-body">
                  <?php $break_time = (!empty($pooja_location->day_wise_time)) ? json_decode($pooja_location->day_wise_time,true) : array('mon'=>array(array('start'=>'','end'=>'','stock'=>'')),'tue'=>array(array('start'=>'','end'=>'','stock'=>'')),'wed'=>array(array('start'=>'','end'=>'','stock'=>'')),'thu'=>array(array('start'=>'','end'=>'','stock'=>'')),'fri'=>array(array('start'=>'','end'=>'','stock'=>'')),'sat'=>array(array('start'=>'','end'=>'','stock'=>'')),'sun'=>array(array('start'=>'','end'=>'','stock'=>'')),'mon_stock'=>0,'tue_stock'=>0,'wed_stock'=>0,'thu_stock'=>0,'fri_stock'=>0,'sat_stock'=>0,'sun_stock'=>0);
                    
                    $stocks = (!empty($pooja_location->day_wise_stock)) ? json_decode($pooja_location->day_wise_stock,true) : array('mon'=>0,'tue'=>0,'wed'=>0,'thu'=>0,'fri'=>0,'sat'=>0,'sun'=>0);
					 $anytimevalue = (!empty($pooja_location->any_time)) ? json_decode($pooja_location->any_time,true) : array('mon'=>0,'tue'=>0,'wed'=>0,'thu'=>0,'fri'=>0,'sat'=>0,'sun'=>0);

                     ?>
                  <?php foreach ($days as $key => $value) { ?>
                  <?php $ix=0; foreach ($break_time[$days[$key]] as $br_key => $breaktime) { ?>
                  <div class="col-sm-10 form-group break_group <?php echo $value;?>">
                     <label class="col-sm-2 control-label" for="inputEmail3"> 
                     <?php
                        switch ($value) {
                           case 'mon':
                           $which = "Monday";
                           $stock_value = $stocks['mon'];
                           echo "Monday";
                             break;
                           case 'tue':
                           $which = "Tuesday";
                           $stock_value = $stocks['tue'];
                           echo "Tuesday";
                             break;
                           case 'wed':
                           $which = "Wedns";
                           $stock_value = $stocks['wed'];
                           echo "Wednesday";
                             break;
                           case 'thu':
                           $which = "Thursday";
                           $stock_value = $stocks['thu'];
                           echo "Thursday";
                             break;
                           case 'fri':
                           $which = "Friday";
                           $stock_value = $stocks['fri'];
                           echo "Friday";
                             break;
                           case 'sat':
                           $which = "Saturday";
                           $stock_value = $stocks['sat'];
                           echo "Saturday";
                             break;
                            case 'sun':
                           $which = "Sunday";
                           $stock_value = $stocks['sun'];
                           echo "Sunday";
                             break;
                     ...
                     <div class="col-sm-3">
                      <?php $s1 = '';$s2 = ''; if ($breaktime['start'] != '') 
                      {
                        $s1 = date("H:i",strtotime($breaktime['start']));
                      }
                      if ($breaktime['end'] != '') 
                      {
                        $s2 = date("H:i",strtotime($breaktime['end']));
                      }
                       ?>
                        <input type="time"  placeholder="Start Time" id="<?php echo $value.'_break_start';?>"  value="<?=$s1?>"  name="break[<?php echo $days[$key];?>][start][]" class="form-control  start <?php echo $days[$key].'_break';?>">
                     </div>
                     <div class="col-sm-3">
                        <input type="time"  placeholder="End Time" id="<?php echo $value.'_break_end';?>"  value="<?=$s2?>" name="break[<?php echo $days[$key];?>][end][]" class="form-control  end <?php echo $days[$key].'_break';?>">
                     </div>
                     <label class="col-sm-2 control-label" for="inputEmail3">
                        <div class="btn-group">
                  ...
                  <div class="col-sm-2 form-group">
                     <?php if ($ix == 0):?>
                      <label class="control-label"><?=$which?> Stock</label>
                      <input type="number" min="0" name="stocks[]" placeholder="Stock" value="<?=$stock_value?>" class="form-control">
                      <?php endif ?>
                  </div>
 ...
 switch ($value) {
                           case 'mon':
                           $which = "Monday";
                           $any_value = $anytimevalue['mon'];
                          
                             break;
                           case 'tue':
                           $which = "Tuesday";
                           $any_value = $anytimevalue['tue'];
                          
                             break;
                           case 'wed':
                           $which = "Wedns";
                           $any_value = $anytimevalue['wed'];
                          
                             break;
                           case 'thu':
                           $which = "Thursday";
                           $any_value = $anytimevalue['thu'];
                          
                             break;
                           case 'fri':
                           $which = "Friday";
                           $any_value = $anytimevalue['fri'];
                           
                             break;
                           case 'sat':
                           $which = "Saturday";
                           $any_value = $anytimevalue['sat'];
                         
                             break;
                            case 'sun':
                           $which = "Sunday";
                           $any_value = $anytimevalue['sun'];
 ...
 ?>
        ...
        <label class="btn button-grid <?php echo $ac;?>">
           <input type="checkbox" class="form-control" name="anytime[<?php echo $value?>]" <?php echo $che;?>>
                   <span class="checkmark"></span>
            <span class="button-grid-word"><?php echo $which?></span>
