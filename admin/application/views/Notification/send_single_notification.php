      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               ...
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" action="<?= base_url('Notification_send/send_single_notification/'); ?>" method="post" data-parsley-validate="" class="validate" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="col-md-12">
