               ...
               <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                                 ...
                                 <div class="modal-body">
                                    <form enctype="multipart/form-data" method="post">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <img width="200" height="200" src="<?=base_url('uploads/yoga/'.$card->image)?>">
                                       </div>
                                      <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="number" value="<?=$card->price?>" min="1" name="price" class="form-control" placeholder="price" required>
                                     </div>
                                     <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="number" value="<?=$card->position?>" min="1" name="position" class="form-control" placeholder="Position" required>
                                     </div>
                        ...
                        <tr>
                           <td class="center"><img src="<?=base_url('uploads/yoga/'.$card->image)?>" height="100" width="100"></td>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/yogas_management/delete_yogas/<?php echo $card->id; ?>" onClick="return doconfirm()">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form enctype="multipart/form-data" method="post">
               ...
               <div class="form-group">
                  <label for="">Price<span style="color: red">*</span></label>
                  <input type="text" min="1" name="price" class="form-control" placeholder="price" required>
               </div>
               <div class="form-group">
                  <label for="">Description<span style="color: red">*</span></label>
