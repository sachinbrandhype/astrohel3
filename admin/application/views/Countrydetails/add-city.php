                           ...
                           <td class="center">	
                              ...
                              <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="min-width: 101px;">
                                      <li>  <a class="btn btn-sm " href="<?php echo base_url();?>Country_ctrl/edit_citysdetails/<?php echo $city->id; ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                                      </li>
                                      <li>  <a class="btn btn-sm " href="<?php echo base_url();?>Country_ctrl/delete_citys/<?php echo $city->id; ?>" onClick="return doconfirm()">
