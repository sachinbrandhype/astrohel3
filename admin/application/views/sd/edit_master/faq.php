                     ...
                     <tbody>
                        ...
                        <div id="update_category_<?=$card->id?>" class="modal fade" role="dialog">
                                    ...
                                    <form method="post">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select name="type" class="form-control" required>
                                             ...
                                             <option value="1" <?=$card->type == 1 ? 'selected' : ''?>>User</option>
                                             <option value="2" <?=$card->type == 2 ? 'selected' : ''?>>Astrologer</option>
                                          </select>
                                       </div>
                           ...
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="quection"   required=""><?=$card->quection?></textarea>
                              <input type="hidden" name="id" value="<?=$card->id?>">
                           </div>
                          
                           <div class="form-group">
                              <label for="">Answer<span style="color: red">*</span></label>
                             <textarea class="form-control" name="answer"  required=""><?=$card->answer?></textarea>
                           </div>
                        ...
                        <tr>
                           <td class="center"><?php 
                            ...
                            ?></td>
                           <td class="center"><?php echo $card->quection; ?></td>
                           <td class="center"><?php echo $card->answer; ?></td>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/edit_master/delete_faq_status/<?php echo $card->id; ?>" onClick="return doconfirm()">
