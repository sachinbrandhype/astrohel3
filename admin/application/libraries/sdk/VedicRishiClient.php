...
*/
    ...
    private function packageHoroData_laalkitab($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$chartType)
    {
        return array(
            'day' => $date,
            'month' => $month,
    ...
    private function packageHoroData_2($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$gender)
    {
        return array(
            'day' => $date,
            'month' => $month,
    ...
    private function packageHoroData_chart($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$chartType)
    {
        return array(
            'day' => $date,
            'month' => $month,
    ...
    private function Varshpal_details($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $varshaphal_year,$chartType)
    {
        return array(
    ...
    private function Varshpal_details_withoutchart($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $varshaphal_year)
    {
        return array(
            'varshaphal_year' => $varshaphal_year,
            'day' => $date,
    ...
    private function kpsystem($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        return array(
            'day' => $date,
            'month' => $month,
    ...
    // private function packageMatchMakingData2($maleBirthData, $femaleBirthData)
    // {
    //     $mData = array(
    //         'm_day' => $maleBirthData['date'],
    //         'm_month' => $maleBirthData['month'],
    ...
    private function packageMatchMakingData2($maleBirthData, $femaleBirthData)
    {
        ...
        $fData = array(
            ...
            'f_lon' => $femaleBirthData['longitude'],
            'f_tzone' => $femaleBirthData['timezone'],
            'match_method' => $femaleBirthData['match_method'],
            'manglik_regional_setting' => $femaleBirthData['manglik_regional_setting'],
        );
    ...
    public function matchDashakootPoints(array $maleBirthData, array $femaleBirthData)
    {
        //TODO:  needs to validate male and female birth data against expected keys
        //$this->dataSanityCheck($maleBirthData);
        //$this->dataSanityCheck($femaleBirthData);
        $resourceName = 'match_dashakoot_points';
        $data = $this->packageMatchMakingData($maleBirthData, $femaleBirthData);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getmatch_making_detailed_report(array $maleBirthData, array $femaleBirthData)
    {
        //TODO:  needs to validate male and female birth data against expected keys
        //$this->dataSanityCheck($maleBirthData);
        //$this->dataSanityCheck($femaleBirthData);
        $resourceName = 'match_making_detailed_report';
        $data = $this->packageMatchMakingData($maleBirthData, $femaleBirthData);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function get_match_rajju_dosha(array $maleBirthData, array $femaleBirthData)
    {
        //TODO:  needs to validate male and female birth data against expected keys
        //$this->dataSanityCheck($maleBirthData);
        //$this->dataSanityCheck($femaleBirthData);
        $resourceName = 'match_rajju_dosha';
        $data = $this->packageMatchMakingData($maleBirthData, $femaleBirthData);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getmatch_horoscope(array $maleBirthData, array $femaleBirthData)
    {
       $resourceName = 'match_horoscope';
       $data = $this->packageMatchMakingData2($maleBirthData, $femaleBirthData);
       $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
       return $response;
    }
    ...
    public function getNumerodaily($date, $month, $year, $name)
    {
     ...
     /*Laal Kitaab*/
    public function getLaalKitabchat($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$chartType)
    {
        $resourceName = 'lalkitab_horoscope';
        $data = $this->packageHoroData_laalkitab($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$chartType);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getLaalKitabdebts($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'lalkitab_debts';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getlalkitab_houses($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getlalkitab_planets($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getlalkitab_reports($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'lalkitab_reports';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getLaalKitabremedies($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$planet_name)
    {
        $resourceName = 'lalkitab_remedies/'.$planet_name;
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    // Sadhe Sati Report/sadhesati_life_details
    public function getSadesati($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getSadesati_current($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
     ...
     // Gem suggestion getBasic_gem_suggestion
    public function getBasic_gem_suggestion($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getDailyNakshatraPrediction($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$resourceName)
    {
        //$resourceName = 'daily_nakshatra_prediction/next';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getJaminiDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'jaimini_details';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getBhavmadhya($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getSubVimDashaDate($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$gender = '',$sub)
    {
        $resourceName = 'sub_vdasha/'.$sub;
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getmpapasamyam_details($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$gender)
    {
        $resourceName = 'papasamyam_details';
        $data = $this->packageHoroData_2($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$gender);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data,$this->language);
        return $response;
    }
    ...
    public function getExtendedHoroChartImageById($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $chartId,$chartType)
    {
        $resourceName = 'horo_chart_image/'.$chartId;
        $data = $this->packageHoroData_chart($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$chartType);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getPlanetnatureReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getMoonbioReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getpersonrepoReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function ghat_chakra($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$gender)
    {
        $resourceName = 'ghat_chakra';
        $data = $this->packageHoroData_2($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $gender);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    // *****Varshpal
    public function varshaphal_details($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$varshaphal_year,$resourceName,$chartType)
    {
        //$resourceName = 'varshaphal_details';
        $data = $this->Varshpal_details($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $varshaphal_year,$chartType);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function varshaphal_details_text($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$varshaphal_year)
    {
        $resourceName = 'varshaphal_details';
        $data = $this->Varshpal_details_withoutchart($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $varshaphal_year);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function varshaphal_on_demand($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$varshaphal_year,$resourceName)
    {
        //$resourceName = 'varshaphal_details';
        $data = $this->Varshpal_details_withoutchart($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $varshaphal_year);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
    ...
    // *****kpsystem
    public function kpsystem_details($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$resourceName)
    {
        //$resourceName = 'varshaphal_details';
        $data = $this->kpsystem($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
