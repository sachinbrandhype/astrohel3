<div class="content-wrapper">
                ...
                <!-- form start -->
				 ...
				 <div class="col-md-6">
								   ...
								   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label  class="intrate">Whats app Number</label>
                                    <input  class="form-control regcom required" type="number" name="whats_number" data-parsley-trigger="keyup" required="" id="whats_number" value="<?php echo $result->whats_number; ?>" >
                                    </div>

                                    <div class="form-group">
                                    <label  class="intrate">Address</label>
                                    <input  class="form-control regcom required" type="text" name="address"  required="" id="address" value="<?php echo $result->address; ?>" >
                                    </div>
 ...
 -->
                                     ...
                                     <div class="form-group has-feedback">
                                   <label for="exampleInputEmail1">website_banner</label>
                                   <input name="website_banner" class="" accept="image/*" type="file" value="<?php echo $result->website_banner; ?>">
                                   <img src="<?php echo base_url("uploads/common")."/".$result->website_banner; ?>" width="100px" height="100px" alt="Picture Not Found"/>
                                   </div>   
