...
<html>
  <head>
    ...
    <title>Astrologers | Log in</title>
  ...
  <body class="hold-transition login-page" style="background-image: url(<?=base_url('assets/images').'/wp2741754.jpg'?>); background-size: cover;background-position: 10%;">
    <div class="login-box">
      <div class="login-logo">
        <a  href="<?php echo base_url('astrologers_admin/Astrologers_admin'); ?>">
      ...
      <div class="login-box-body">
        ...
        <p class="login-box-msg">Astrologers Sign in to start your session</p>
        ...
        <form action="" method="post">
          ...
          <div class="row">
           ...
           <!--      <a href="<?php echo base_url()?>forgot_password" style="float: right;"  ><i class="fa fa-arrow-left"></i> Forgot Password</button></a> -->
