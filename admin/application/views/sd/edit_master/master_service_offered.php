                  ...
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <select name="in_home" class="form-control" required>
                                             ...
                                             <option value="1" <?=$card->in_home == 1 ? 'selected' : ''?>>Yes</option>
                                             <option value="0" <?=$card->in_home == 0 ? 'selected' : ''?>>No</option>
                                          </select>
                                       </div>
                                       <div class="form-group">
                        ...
                        <tr>
                           ...
                           <td><span class="center label  <?php if ($card->in_home == '1') {
                              echo "label-success";
                              } else {
                              echo "label-warning";
                              }
                              ?>"><?php if ($card->in_home == '1') {
                              echo "Yes";
                              } else {
                              echo "No";
                              }
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/edit_master/delete_master_service_offered/<?php echo $card->id; ?>" onClick="return doconfirm()">
