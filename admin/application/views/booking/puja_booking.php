<div class="content-wrapper" >
     ...
     elseif ($uri == "cancel_booking") 
      {
        ...
        ?>
       Puja <?php echo $status ; ?>
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-dashboard"></i>Home</a></li>
         <li class="active">Puja <?php echo $status ; ?> </li>
      </ol>
   </section>
 ...
 -->
                             ...
                             <td class="center"><?= $key->schedule_date  ; ?></td>
                             <td class="center"><?= $key->schedule_time  ; ?></td>
