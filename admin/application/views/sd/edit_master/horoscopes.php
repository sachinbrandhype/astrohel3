               ...
               <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                                 ...
                                 <div class="modal-body">
                                    <form enctype="multipart/form-data" method="post">
                                        <div class="form-group">
                                          ...
                                          <input type="text"  name="name" class="form-control" placeholder="Name" value="<?=$card->name?>" required>
                                       </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <img width="200" height="200" src="<?=base_url('uploads/horoscope/'.$card->image)?>">
                                       </div>

                                         <div class="form-group">
                                      <label for="">Description<span style="color: red">*</span></label>
                                      <textarea name="description" class="form-control" required=""><?=$card->description?></textarea>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input value="<?=$card->start_date?>" type="date"  name="start_date" class="form-control" placeholder="Start Date" required>
                                       </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input value="<?=$card->end_date?>" type="date"  name="end_date" class="form-control" placeholder="End Date" required>
                                       </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input value="<?=$card->position?>" type="number" min="1" name="position" class="form-control" placeholder="Position" required>
                                       </div>
                                       <div class="form-group">
                        ...
                        <tr>
                           <td class="center"><img src="<?=base_url('uploads/horoscope/'.$card->image)?>" height="100" width="100"></td>
                           <td class="center"><?=$card->name?></td>
                          <td class="center"><?php echo date("d-m-Y",  strtotime($card->start_date )); ?></td>
                          <td class="center"><?php echo date("d-m-Y",  strtotime($card->end_date )); ?></td>
                          
                           <td class="center"><?=$card->position?></td>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/edit_master/delete_horoscope/<?php echo $card->id; ?>" onClick="return doconfirm()">
