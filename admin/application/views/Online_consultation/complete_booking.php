<div class="content-wrapper" >
   ...
   <section class="content-header">
      <h1>
        Online Consultation Complete Booking 
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-user-md"></i>Home</a></li>
         <li class="active">Online Consultation Complete Booking </li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            ...
            <span><a href="<?php echo base_url()?>Online_consultation/export_online_doctor/complete_booking"> 
  ...
  <div class="row">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">Online Consultation Complete Booking </h3>
               </div>
                       ...
                       <?php if ($list): ?>
                          ...
                          <tr>
                             ...
                             <td class="center"><?php echo $x;?></td>
                                <td class="center">
                              <?php
                               if ($key->online_mode =="video" )
                              {
                                echo "Video";
                              }
                              elseif ($key->online_mode =="audio") {
                                 echo "Audio";
                              }
                              else
                              {
                             ...
                             <td class="center"><?= $key->gender; ?></td>
                             <td class="center"><?= $key->dob; ?></td>
                             <td class="center"><?= $key->problem; ?></td>
                             <td class="center"><?= $key->pob_lat_long_address; ?></td>
...
<script>
 ...
 <script>
function myFunction_refund() {
  
  var booking_id = $(".booking_id").val();
  var refund_trxn_id = $("#refund_trxn_id").val();
  ...
  {
    alert('sdfdsfsfd');
    //var x = document.getElementById("refund_trxn_id").required;
    $(".booking_id").prop('required',true);
    $("#refund_trxn_id").prop('required',true);
    $("#refund_amount").prop('required',true);
    $("#refund_date").prop('required',true);
 
    $.ajax({
           type: "POST",
           url: "<?php echo base_url('medical_doorstep/refund_data');?>",
           data: {booking_id: booking_id,refund_trxn_id:refund_trxn_id,refund_date:refund_date,refund_amount:refund_amount},
           method: "post",
            beforeSend: function(){
            $("#loading-image").show();
            },
