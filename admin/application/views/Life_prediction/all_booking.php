     ...
     elseif ($uri == "cancel_booking") 
      {
        ...
        ?>
       Life Prediction  <?php echo $status ; ?>
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-dashboard"></i>Home</a></li>
         <li class="active">Life Prediction <?php echo $status ; ?> </li>
      </ol>
   </section>
                       ...
                       <?php if ($list): ?>
                          ...
                          <tr>
                           ...
                           <!--   <td class="center"><?= $key->email; ?></td>
                             ...
                             <td class="center"><?php
                               $new_date = date("d/m/Y", strtotime($key->dob));
                               echo $new_date;
                              ?></td>
                             ...
                             <td class="center">
                                        ...
                                        if(!empty($key->images)){
                                            foreach ($file_arr as $a) {
                                                $im = explode(",",$a);
                                                ?>
                                                <a target="_blank" href="<?=base_url().'uploads/life_prediction/'.$im[0]?>">File - <?=$q++?></a><br/>
                                                <?php
                                            }
                                        }
                                        ?>
                              ...
                              if ($key->status == 0) {
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="<?=base_url('Life_prediction/image_pdf_data')?>" enctype="multipart/form-data">
                                                                <div class="form-group">
                               ...
                               ?>
                                 ...
                                 <?php
                                        ...
                                        ?>
                                            <a onclick="return confirm('Are you sure?')" class="btn btn-sm btn-primary" href="<?= base_url('Life_prediction/confirm_booking/' . $key->id) ?>">Confirm</a>
                                        <?php
                                        }
                                        ?>
                               </td>
