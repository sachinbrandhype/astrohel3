<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Add Complain Reason </li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title"> Add Complain Reason  </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" action="<?=base_url('affiliate_ctrl/add_complain_reason')?>" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="col-md-12">
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Complain Reason  Name</label>
                           <input type="text" class="form-control required" data-parsley-trigger="change" data-parsley-minlength="2"  required="" name="name"  placeholder="Complain Reason Name">
                      ...
                      <table id="" class="table table-bordered table-striped datatable">
                           <thead>
                              <tr>
                                 ...
                                 <th>Complain Reason  Name</th>
                                 <th>Action</th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php
                                 foreach($complain_reason as $key) {			 
                                 ?>
                              <tr>
                                
                                 <td class="center"><?php echo $key->name; ?></td>
                                 <td class="center">	
                                    <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Affiliate_ctrl/edit_complain_reason/<?php echo $key->id; ?>">
                                    <i class="fa fa-fw fa-edit"></i>Edit</a>
                                    <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>Affiliate_ctrl/delete_complain_reason/<?php echo $key->id; ?>" onClick="return doconfirm()">
