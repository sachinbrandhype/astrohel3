                  ...
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    <form method="post">
                                       ...
                                       <div class="form-group">
                                          <label for="">Hindi Name<span style="color: red">*</span></label>
                                          <input type="text" name="hindi_name" value="<?=$card->hindi_name?>" class="form-control" placeholder="Hindi Name" required>
                                         
                                       </div>
                                       <div class="form-group">
                                          <label for="">Gujrati Name<span style="color: red">*</span></label>
                                          <input type="text" name="gujrati_name" value="<?=$card->gujrati_name?>" class="form-control" placeholder="Gujrati Name" required>
                        ...
                        <tr>
                           ...
                           <td class="center"><?php echo $card->hindi_name; ?></td>
                           <td class="center"><?php echo $card->gujrati_name; ?></td>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/edit_master/delete_master_temple/<?php echo $card->id; ?>" onClick="return doconfirm()">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form method="post">
               ...
               <div class="form-group">
                  <label for="">Hindi Name<span style="color: red">*</span></label>
                  <input type="text" name="hindi_name" class="form-control" placeholder="Hindi Name" required>
               </div>
               <div class="form-group">
                  <label for="">Gujrati Name<span style="color: red">*</span></label>
                  <input type="text" name="gujrati_name" class="form-control" placeholder="Gujrati Name" required>
               </div>
               <div class="form-group">
                  <label for="">Status<span style="color: red">*</span></label>
                  <select name="status" class="form-control" required>
