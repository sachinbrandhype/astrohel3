<div class="content-wrapper" >
   ...
   <section class="content-header">
      <h1>
       Online Consultation  New Booking 
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-user-md"></i>Home</a></li>
         <li class="active">  Online Consultation New Booking </li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            ...
            <span><a href="<?php echo base_url()?>Online_consultation/export_online_doctor/new_booking"> 
  ...
  <div class="row">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title"> Online Consultation New Booking </h3>
               </div>
