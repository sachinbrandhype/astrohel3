                  ...
                  <div class="box-body">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input required type="text" name="name" class="form-control" placeholder="Name" required>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input required type="number" min="0"  name="discount_price" class="form-control" onkeyup="if(parseInt(this.value)<0){ this.value =0; return false; }" placeholder="Discount Price">
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <select required class="form-control select2 js-example-basic-multiple" name="multiple_location[]" placeholder="Locations">
                              <option value="">Select..</option>
                             <?php  
                        ...
                        <div class="form-group">
                           <label for="">In App<span style="color: red">*</span></label>
                              ...
                              <div class="box-body no-padding">
                                 <table class="table table-striped">
                                    <tr>
                                       ...
                                       <th>Starting Time</th>
                                       <th>Ending Time</th>
                                       <th><input type="checkbox" class="checkbox_check_clinic" name="test1" value=""></th>
                                    </tr>
                                    <tr>
                                       <td>1.</td>
                                       <td>Monday</td>
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="monday[0][start]" class="form-control timepicker clinic_start1" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group monday1">
                                                <div class="input-group">
                                                   <input type="text" name="monday[1][start]" class="form-control timepicker clinic_end1" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="monday[0][end]" class="form-control timepicker clinic_start2" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group monday1">
                                                <div class="input-group">
                                                   <input type="text" name="monday[1][end]" class="form-control timepicker clinic_end2" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle11"></span></td>
                                    </tr>
                                    <tr>
                                       <td>2.</td>
                                       <td>Tuesday</td>
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group ">
                                                <div class="input-group">
                                                   <input type="text" name="tuesday[0][start]" class="form-control timepicker c11" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group tuesday1">
                                                <div class="input-group">
                                                   <input type="text" name="tuesday[1][start]" class="form-control timepicker c12" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="tuesday[0][end]" class="form-control timepicker c13" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group tuesday1">
                                                <div class="input-group">
                                                   <input type="text" name="tuesday[1][end]" class="form-control timepicker c14" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle21"></span></td>
                                    </tr>
                                    <tr>
                                       <td>3.</td>
                                       <td>Wednesday</td>
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="wednesday[0][start]" class="form-control timepicker c11" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group wednesday1">
                                                <div class="input-group">
                                                   <input type="text" name="wednesday[1][start]" class="form-control timepicker c12" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="wednesday[0][end]" class="form-control timepicker c13" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group wednesday1">
                                                <div class="input-group">
                                                   <input type="text" name="wednesday[1][end]" class="form-control timepicker c14" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle31"></span></td>
                                    <tr>
                                       <td>4.</td>
                                       <td>Thursday</td>
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="thursday[0][start]" class="form-control timepicker c11" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group thursday1">
                                                <div class="input-group">
                                                   <input type="text" name="thursday[1][start]" class="form-control timepicker c12" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="thursday[0][end]" class="form-control timepicker c13" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group thursday1">
                                                <div class="input-group">
                                                   <input type="text" name="thursday[1][end]" class="form-control timepicker c14" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle41"></span></td>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="friday[0][start]" class="form-control timepicker c11" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group friday1">
                                                <div class="input-group">
                                                   <input type="text" name="friday[1][start]" class="form-control timepicker c12" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="friday[0][end]" class="form-control timepicker c13" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group friday1">
                                                <div class="input-group">
                                                   <input type="text" name="friday[1][end]" class="form-control timepicker c14" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle51"></span></td>
                                    </tr>
                                    <tr>
                                       <td>6.</td>
                                       <td>Saturday</td>
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="saturday[0][start]" class="form-control timepicker c11" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group saturday1">
                                                <div class="input-group">
                                                   <input type="text" name="saturday[1][start]" class="form-control timepicker c12" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="saturday[0][end]" class="form-control timepicker c13" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group saturday1">
                                                <div class="input-group">
                                                   <input type="text" name="saturday[1][end]" class="form-control timepicker c14" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle61"></span></td>
                                    </tr>
                                    <tr>
                                       <td>7.</td>
                                       <td>Sunday</td>
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group">
                                                <div class="input-group">
                                                   <input type="text" name="sunday[0][start]" class="form-control timepicker c11" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group sunday1">
                                                <div class="input-group">
                                                   <input type="text" name="sunday[1][start]" class="form-control timepicker c12" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td>
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group ">
                                                <div class="input-group">
                                                   <input type="text" name="sunday[0][end]" class="form-control timepicker c13" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                          ...
                                          <div class="bootstrap-timepicker">
                                             <div class="form-group sunday1">
                                                <div class="input-group">
                                                   <input type="text" name="sunday[1][end]" class="form-control timepicker c14" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9][a-z][a-z]">
                                                   <div class="input-group-addon">
                                                      <i class="fa fa-clock-o"></i>
                                                   </div>
                                                </div>
                                       ...
                                       <td><span id="monbutton" class="remove fa fa-plus-circle toggle71"></span></td>
                                    </tr>
                                 </table>
                              </div>
                           </div>
