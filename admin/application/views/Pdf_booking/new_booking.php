<div class="content-wrapper" >
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Pdf New Booking </li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            ...
            <a href="<?php echo base_url()?>Pdf_booking/export_online_doctor/new_booking"> 
                  <button type="button" class="btn add-new float-right" style="float: right; margin-right: 10px; margin-left: 10px;">Export</button></a>
           
            <br>
            <br>

            <form method="post" action="<?=base_url('Pdf_booking/new_booking/')?>">
 ...
 <div class="col-md-4">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">Pdf New Booking </h3>
               </div>
