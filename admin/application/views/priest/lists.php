<div class="content-wrapper">
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            <li><a data-toggle='modal' data-target='#add_venue'><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add Priest</b></button></a>
         </ol>
         <div class="col-xs-12">
            <!-- /.box -->
            <div class="box">
                  ...
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                           ...
                           <div class="modal-dialog">
                              ...
                              <div class="modal-content">
                                 <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Edit Priest</h4>
                                 </div>
                                 <div class="modal-body">
                                    <form method="post">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="password" name="password" value="<?=$card->password?>" class="form-control" placeholder="Password" required>
                                       </div>
                                       <div class="form-group">
                                          <label>Locations<span style="color: red">*</span></label>
                                          <select required class="form-control select2" name="location" placeholder="Locations" required>
                                             <option value="">Select..</option>
                                             <?php  
                                                foreach ($pooja_locations as $key => $v) {
                                                ?>
                                             <option value="<?=$v->id?>" <?=$card->location == $v->id ? 'selected' : ''?>><?=$v->name?></option>
                                             <?php
                                                }
                                                ?>
                                          </select>
                        ...
                        <tr>
                           ...
                           <td class="center">
                           <?php 
                            $location = $this->db->get_where('puja_location',array("id"=>$card->location))->row();
                             echo $location->name; ?>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>priest/delete_priest/<?php echo $card->id; ?>" onClick="return doconfirm()">
...
<div id="add_venue" class="modal fade" role="dialog">
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Add Priest</h4>
         </div>
         <div class="modal-body">
            <form method="post">
               <div class="form-group">
