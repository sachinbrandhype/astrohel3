<div class="content-wrapper" >
   ...
   <section class="content-header">
      <h1>
        Pdf Complete Booking 
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-user-md"></i>Home</a></li>
         <li class="active">Pdf Complete Booking </li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            ...
            <a href="<?php echo base_url()?>Pdf_booking/export_online_doctor/complete_booking"> 
                  <button type="button" class="btn add-new float-right" style="float: right; margin-right: 10px; margin-left: 10px;">Export</button></a>
           
            <br>
            <br>

            <form method="post" action="<?=base_url('Pdf_booking/complete_booking/')?>">
 ...
 <div class="col-md-4">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">Pdf Complete Booking </h3>
               </div>
