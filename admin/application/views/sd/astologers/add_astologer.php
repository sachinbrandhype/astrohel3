      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               ...
               <!-- /.box-header -->
               <!-- form start -->
               <form action="<?=base_url('sd/astrologers/insert');?>" method="post"  
                  ...
                  <div class="box-body">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input required type="number" name="discount" class="form-control" placeholder="Discount" min="1" max="99">
                        </div>
                        <div class="form-group">
                       ...
                       <!--  <div id="online_p" class="form-group">
                        ...
                        <div id="per_mint" class="form-group" style="display: block;">
                           ...
                           <div class="form-group">
                              ...
                              <input  value="0" value="0" type="number" min="0" step="any"  name="price_per_mint_chat" class="form-control" placeholder="Price per Minute">
                           </div>
                        

                           <div class="form-group">
                              <label>Per Minute Video Charge<span style="color: red;">*</span></label>
                              <input  value="0" value="0" type="number" min="0" step="any"  name="price_per_mint_video" class="form-control" placeholder="Price per Minute">
                           </div>
                        

                           <div class="form-group">
                              <label>Per Minute Audio Charge<span style="color: red;">*</span></label>
                              <input  value="0" value="0" type="number" min="0" step="any"  name="price_per_mint_audio" class="form-control" placeholder="Price per Minute">
                           </div>
                        ...
                        <div class="form-group">
                           ...
                           <div id="supplement_div"></div>
                            ...
                            <div class="col-lg-6">
                               ...
                               <div class="col-lg-4">
                                <label for="">Price</label>
                                <input type="number" name="specialization_price[]" class="form-control" placeholder="Price" required>
                                </div>
                                <div class="col-lg-2">
                                 <br>
