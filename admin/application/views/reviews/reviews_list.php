<div class="content-wrapper" >
   ...
   <section class="content">
      <div class="row">
         ...
         <div class="col-xs-12">
         <ol class="breadcrumb">
            <li> <!-- <a data-toggle='modal' data-target='#add_category'><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add Reviews</b></button></a> -->
                       ...
                       <?php if ($list): ?>
                          ...
                          <tr>
                             ...
                             <td class="center"><?php 
                              if ($key->type == 1) {
                                    $type_id= $key->type_id;
                                    $puja = $this->db->where('id',$type_id)->get('puja')->row();
                                     if ($puja) {
                                       echo $puja->name;
                                     }
                                }
                                  ...
                                  $type_id= $key->type_id;
                                    $astrologers = $this->db->where('id',$type_id)->get('astrologers')->row();
                                     if ($astrologers) {
                                       echo $astrologers->name;
                                }
                              }
                                ?></td>

                             <td class="center"><?php echo $key->booking_id;?></td>
                             ...
                             <td class="center"><?php echo $key->rate;?></td>
                             <td class="center"><?php echo $key->message;?></td>
                        <!--      <td class="center"><?php echo $key->status;?></td>
                         ...
                         -->
                             ...
                             <td class="center">
                             <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>Reviews/delete_reviews/<?php echo $key->id; ?>" onClick="return doconfirm()">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form method="post">
              ...
              <div class="form-group">
                  <label for="">Puja<span style="color: red">*</span></label>
                  <select name="type" class="form-control" required>
                     <option value="">Select</option>
                     <option value="1" >Puja</option>
                     <option value="2" >Astrologer</option>
               ...
               <div class="form-group">
                  <label for="">Quection<span style="color: red">*</span></label>
                  <textarea class="form-control" name="quection" required=""></textarea>
...
<div class="modal modal-info fade" id="modal-info_refund">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?=base_url('Life_prediction/refund_data')?>" role="form" id="newModalForm" method="POST">
...
function mycancelFunction() {
   var cancel_id = $(".cancel_id").val();
    ...
    $.ajax({
           type: "POST",
           url: "<?php echo base_url('Life_prediction/cancel_booking_id');?>",
