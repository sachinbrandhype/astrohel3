...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li class="active">Send Astrologer Notification</li>
   </ol>
</section>
<!-- Main content -->
   ...
   <div class="col-md-12">
      ...
      <div class="box">
        ...
        <!--     <h3 class="box-title">Send Notification</h3> -->
         ...
         <!-- /.box-header -->
         <!-- form start -->
         <form role="form" action="<?=base_url('Notification_send/send_single_astrologer_notification/');?>" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">
            <div class="box-body">
               <div class="col-md-12">
