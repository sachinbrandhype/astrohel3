                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="date" name="date" value="<?=$editp->date?>" class="form-control" placeholder="Select date" id="sh-date-selection" required>
                        </div>
                        <div class="form-group">
                           <label for="">Stock*</label>
                           <table>
                              <tr>
                                 <td><input value="<?=$editp->stock?>" required type="number" min="0" placeholder="Stock" name="stock" class="form-control"></td>
                              </tr>
                           </table>
                        </div>
                        <div class="form-group">
                           ...
                           <table id="time_m">
                              <?php
                                 $times = json_decode($editp->json);
                                 if(!empty($times)){
                                     foreach ($times as $v) {
                                         ?>
                              <tr>
                                 <td><input type="time" value="<?=date("H:i",strtotime($v->start))?>" placeholder="Start Time" name="start[]" class="form-control"></td>
                                 <td><input type="time" value="<?=date("H:i",strtotime($v->end))?>" placeholder="End Time"  name="end[]" class="form-control"></td>
                        ...
                        <div class="form-group">
                           ...
                           <input type="radio" name="status" value="1" <?=$editp->status == 1 ? 'checked' :''?>> Active<br>
                           <input type="radio" name="status" value="0" <?=$editp->status == 0 ? 'checked' :''?>> Inactive<br>
                        </div>
                     </div>
                  </div>
                  <div class="box">
