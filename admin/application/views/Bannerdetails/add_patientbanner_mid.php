...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url(); ?>banner_ctrl/view_banner_mid">  Mid Banner Details </a></li>
         <li class="active">Add Mid Banner</li>
      </ol>
   </section>
   <!-- Main content -->
  ...
  <form role="form"  method="post" action="<?php echo base_url('banner_ctrl/insert_patientbanner_mid')?>" id="patient banner_reg" data-parsley-validate="" class="validate" enctype="multipart/form-data" >
  
         <div class="col-md-12">
            <!-- general form elements -->             
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Add Mid Banner </h3>
