     ...
     elseif ($uri == "cancel_booking") 
      {
        ...
        ?>
       Match Making <?php echo $status ; ?>
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-dashboard"></i>Home</a></li>
         <li class="active"> Match Making  <?php echo $status ; ?> </li>
      </ol>
   </section>
                     ...
                     <div class="col-md-4">           
                        <div class="form-group">
                          <label>Boy Name</label>
                           <input type="text" value="<?= isset($_GET['boy_name']) ? $_GET['boy_name'] : '' ?>"  class="form-control" name="boy_name" id="from">
                        </div>
                     </div>
                     ...
                     <div class="col-md-4">           
                        <div class="form-group">
                          <label>Girl Name</label>
                           <input type="text" value="<?= isset($_GET['girl_name']) ? $_GET['girl_name'] : '' ?>"  class="form-control" name="girl_name" id="from">
                        </div>
                     </div>
                  ...
                  <table id="" class="table table-bordered table-striped ">
                     <thead>
                        <tr>
                           ...
                           <th>Mobile </th>                                        
                           <th>Boy Name  </th>                                        
                           <th>Boy Date of birth </th>                                        
                           <th>Boy Time of birth   </th>                                        
                           <th>Boy Place of birth  </th>                                             
                           <th>Girl Name  </th>                                        
                           <th>Girl Date of birth </th>                                        
                       ...
                       <?php if ($list): ?>
                          ...
                          <tr>
                             ...
                             <td class="center"><?php echo "Match Making Booking";?></td>
                             ...
                             <td class="center"><?= date("d/m/Y", strtotime($key->boy_dob)); ?></td>
                             <td class="center"><?= date('h:ia', strtotime($key->boy_tob)); ?></td>
                             <td class="center"><?= $key->boy_pob; ?></td>
                             <td class="center"><?= $key->girl_name; ?></td>
                             <td class="center"><?= date("d/m/Y", strtotime($key->girl_dob)); ?></td>
                             <td class="center"><?= date('h:ia', strtotime($key->girl_tob)); ?></td>
                             <td class="center"><?= $key->girl_pob; ?></td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="<?=base_url('Horoscope_matching/image_pdf_data')?>" enctype="multipart/form-data">
                                                                <div class="form-group">
                               ...
                               if($key->status == 2 || $key->status == 3 || $key->status == 4)
                               {
                                if ($key->refund_status == 0) 
                                {
                                  ...
                                  else
                                  {
                                   ...
                                   echo "Refund Date - " .date("d/m/Y", strtotime($key->refund_date))."<br>" ;
...
<div class="modal modal-info fade" id="modal-info_refund">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?=base_url('Horoscope_matching/refund_data')?>" role="form" id="newModalForm" method="POST">
...
function mycancelFunction() {
   var cancel_id = $(".cancel_id").val();
    ...
    $.ajax({
           type: "POST",
           url: "<?php echo base_url('Horoscope_matching/cancel_booking_id');?>",
...
$.ajax({
url: "<?php echo base_url('Horoscope_matching/transaction_details');?>",
method: "POST",
