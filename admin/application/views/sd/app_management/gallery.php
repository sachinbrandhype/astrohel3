               ...
               <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                                 ...
                                 <div class="modal-body">
                                    <form enctype="multipart/form-data" method="post">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <img width="200" height="200" src="<?=base_url('uploads/gallery/'.$card->image)?>">
                                       </div>
                                       <div class="form-group">
                                          <label for="">Position<span style="color: red">*</span></label>
                                          <input value="<?=$card->position?>" type="number" min="1" name="position" class="form-control" placeholder="Name" required>
                                       </div>
                                       <div class="form-group">
                        ...
                        <tr>
                           <td class="center"><img src="<?=base_url('uploads/gallery/'.$card->image)?>" height="100" width="100"></td>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/app_management/delete_gallery/<?php echo $card->id; ?>" onClick="return doconfirm()">
