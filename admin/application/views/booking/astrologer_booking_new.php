      ...
      <div class="row">
         ...
         <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
               <div class="inner">
                  <h3><?=ROUND($astrologer_assets->total_amount_bookings)?><sup style="font-size: 20px"></sup></h3>
         ...
         <div class="col-lg-3 col-xs-6">
			...
			<?php $admern = ROUND($astrologer_assets->total_amount_bookings/2)?>
               <div class="inner">
			<h3><?=$admern?><sup style="font-size: 20px"></sup></h3>
...
<?php 
 ...
 $comm =$adminerning*2.36/100;
 $astroerning = $adminerning - $comm;	
?>
                  <h3><?=ROUND($astroerning)?><sup style="font-size: 20px"></sup></h3>
