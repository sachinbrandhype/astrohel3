<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <ol class="breadcrumb">
                <li><a data-toggle='modal' data-target='#add_venue'><button class="btn add-new" type="button"><b><i class="fa fa-fw fa-plus"></i> Add Yajman</b></button></a>
            </ol>
                                ...
                                <div id="update_venue_<?=$card->id?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Edit Puja Yajman</h4>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select required class="form-control select2 js-example-basic-multiple" name="puja_id" placeholder="Select Puja" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>pooja/delete_pooja_yajman/<?php echo $card->id; ?>" onClick="return doconfirm()">
...
<div id="add_venue" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Add Puja Yajman</h4>
            </div>
            <div class="modal-body">
                <form method="post">
                    <div class="form-group">
