                      ...
                      <tr>
                       ...
                       <?php if ($list): ?>
                          ...
                          <tr>
                             ...
                             <td class="center"><?php echo $key->name;  ?>
                             <td class="center"><?php echo $key->email;  ?>
                             <td class="center"><?php echo $key->phone;  ?>
                             <td class="center"><?php echo $key->message;  ?>
