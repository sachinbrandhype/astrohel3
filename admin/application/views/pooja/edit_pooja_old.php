                  ...
                  <div class="box-body">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input required type="text" value="<?=$pooja->name?>" name="name" class="form-control" placeholder="Name" required>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input required type="number" min="1"  name="price" value="<?=$pooja->price?>" class="form-control" onkeyup="if(parseInt(this.value)<0){ this.value =0; return false; }" placeholder="Price" required>
                        </div>

                        <div class="form-group">
                           <label>Discount Price</label>
                           <input required type="number" min="0"  name="discount_price" value="<?=$pooja->discount_price?>" class="form-control" onkeyup="if(parseInt(this.value)<0){ this.value =0; return false; }" placeholder="Discount Price">
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <select required class="form-control select2 js-example-basic-multiple" name="multiple_location[]" placeholder="Locations">
                             ...
                             foreach ($pooja_locations as $key => $v) {
                                 $explode = explode('|',$pooja->multiple_location);
                                 if(in_array($v->name,$explode)){
                                     $l_s = 'selected';
                                 }else{
                                     $l_s = '';
                                 }
                                ?>
                                <option value="<?=$v->name?>"  <?=$l_s?>><?=$v->name?></option>
                                <?php
                             }
                             ?>
                           </select>
                        ...
                        <div class="form-group">
                           ...
                           <textarea name="description" class="form-control"><?=$pooja->description?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <select name="in_app" class="form-control" required>
                              <option value="">Select</option>
                              <option value="1" <?=$pooja->in_app == 1 ? 'selected' :
                              ''?>>Yes</option>
                              <option value="0"<?=$pooja->in_app == 0 ? 'selected' :
                              ''?>>No</option>
                           </select>
                        </div>
                        <div class="form-group">
                           ...
                           <select name="status" class="form-control" required>
                              <option value="">Select</option>
                              <option value="1" <?=$pooja->status == 1 ? 'selected' :
                              ''?>>Active</option>
                              <option value="0" <?=$pooja->status == 0 ? 'selected' :
                              ''?>>Disable</option>
                           </select>
                        </div>
                     </div>
