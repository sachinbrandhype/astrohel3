...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Add Website advertisment 
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-user-md"></i>Home</a></li>
         <li><a href="<?php echo base_url(); ?>banner_ctrl/view_banner">Website advertisment Details </a></li>
         <li class="active">Add Website advertisment</li>
      </ol>
   </section>
   <!-- Main content -->
  ...
  <form role="form"  method="post" action="<?php echo base_url('banner_ctrl/insert_website_advertisment')?>" id="patient banner_reg" data-parsley-validate="" class="validate" enctype="multipart/form-data" >
  
         <div class="col-md-12">
            <!-- general form elements -->             
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Add Website advertisment </h3>
            ...
            <div class="form-group has-feedback">
                         ...
                         <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control required"  name="sub_title"  placeholder="Sub Title">
                            <span class="glyphicon  form-control-feedback"></span>
                    </div>
