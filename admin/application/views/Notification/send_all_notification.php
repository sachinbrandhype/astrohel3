<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Send Notification to All User</li>
      </ol>
   </section>
   <!-- Main content -->
 ...
 -->
               ...
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" action="<?= base_url('Test_user_ctrl/send/'); ?>" method="post" data-parsley-validate="" class="validate" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="hidden" required name="type" class="form-control" value="1">
                        </div>
