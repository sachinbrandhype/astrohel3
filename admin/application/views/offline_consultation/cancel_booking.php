<div class="content-wrapper" >
   ...
   <section class="content-header">
      <h1>
         Clinic Management Cancel Booking 
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-user-md"></i>Home</a></li>
         <li class="active"> Clinic Management Cancel Booking </li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            ...
            <span><a href="<?php echo base_url()?>offline_consultation/export_offline_doctor/cancel_booking"> 
  ...
  <div class="row">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title"> Clinic Management Cancel Booking </h3>
               </div>
