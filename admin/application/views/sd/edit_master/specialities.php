            ...
            <div class="box">
               ...
               <div class="box-body">
                  ...
                  <input type="text"  name="name" class="form-control" placeholder="Name" value="<?=$card->name?>" required>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <img width="200" height="200" src="<?=base_url('uploads/specialities/'.$card->image)?>">
                                       </div>

                                         <div class="form-group">
                  <label for="">Description<span style="color: red">*</span></label>

                  <input type="text" value="<?=$card->description?>"  name="description" class="form-control" placeholder="Description" required>
               </div>
               ...
               <div class="form-group">
                  ...
                  <select name="type" class="form-control" required>
                     ...
                     <option value="1" <?=$card->type == 1 ? 'selected' : ''?>>Speciality</option>
                     <option value="2" <?=$card->type == 2 ? 'selected' : ''?>>Service</option>
                  </select>
               </div>
               <div class="form-group">
                  <label for="">Show Home<span style="color: red">*</span></label>
                  <select name="show_home" class="form-control" required>
                     <option value="">Select</option>
                     <option value="1" <?=$card->show_home == 1 ? 'selected' : ''?>>Yes</option>
                     <option value="0" <?=$card->show_home == 0 ? 'selected' : ''?>>No</option>
                  </select>
               </div>
                        ...
                        <tr>
                           <td class="center"><img src="<?=base_url('uploads/specialities/'.$card->image)?>" height="100" width="100"></td>
                           ...
                           <td>
                              ...
                              <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>sd/edit_master/delete_specialities/<?php echo $card->id; ?>" onClick="return doconfirm()">
