<div class="content-wrapper" >
   ...
   <section class="content-header">
      <h1>
        Clinic Management Complete Booking 
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url();?>Welcome/"><i class="fa fa-user-md"></i>Home</a></li>
         <li class="active">Clinic Management Complete Booking </li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="row">
         ...
         <ol class="breadcrumb">
            ...
            <span><a href="<?php echo base_url()?>offline_consultation/export_offline_doctor/complete_booking"> 
  ...
  <div class="row">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">Clinic Management Complete Booking </h3>
               </div>
                     ...
                     <tfoot>
                        <tr>
                          <th>ID </th>                                           
                           ...
                           <th>Cancel Doctor </th> 
                           <th>Trxn Detail</th>
                           <th>Cancel By</th><th>Status</th>  <th>Refund</th>
                          <!--  <th>Complete On</th> -->
