<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Add User News</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title"> Add User News</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" action="" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">
                  <div class="box-body">                 
                    ...
                    <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control required" data-parsley-trigger="change"  required name="url"  placeholder="Url">
                            <span class="glyphicon  form-control-feedback"></span>
                    </div>
                      ...
                      <div class="form-group has-feedback">
                            ...
                            <input type="date" class="form-control required" data-parsley-trigger="change"  required name="date"    placeholder="date">
                            <span class="glyphicon  form-control-feedback" ></span>
                    </div>
                     ...
                     <div class="form-group has-feedback">
                            ...
                            <input type="number" class="form-control required" data-parsley-trigger="change" min="1" required name="position"  placeholder="Position">
                            <span class="glyphicon  form-control-feedback" ></span>
                    </div>
